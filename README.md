...
The project is designed so the same codebase can power multiple TV instances, domains and editorial projects through configuration rather than custom development.


## License

TV App is free software licensed under the
